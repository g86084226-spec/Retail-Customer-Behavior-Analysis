...
INSERT INTO customer (customer_id, age, gender, item_purchased, category, purchase_amount, location, size, color, season, review_rating, subscription_status, shipping_type, discount_applied, promo_code_used, previous_purchases, payment_method, frequency_of_purchases) VALUES
...
-- What is the total revevnue generated by sales vs. female customers?
...
-- This compares subscribers and non-subscribers using three measures

-- Number of customers
-- Average purchase amount
-- Total revenue

-- For the question "Do subscribed customers spend more?", pay particular attention to avg_spend.

-- Q6. Top 5 products with the highest percentage of purchases where discounts were applied
SELECT 
    item_purchased,
